...
wp_redirect( home_url() . '/tricoastal');
exit;
}
?>
<!DOCTYPE html>
  ...
  <header>
      ...
      <div class="container"> 
        <div class="col-md-12 row">
            <a class="navbar-brand" href="<?php bloginfo( 'url' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo-u83-fr.png"></a>
             <p class="slogan">Diversity &amp; Stability Beyond Traditional Investments</p>
          </div>
        </div>
      </div>
